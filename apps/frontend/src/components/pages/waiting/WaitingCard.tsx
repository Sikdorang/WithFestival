    ...
    return (
      <div className="space-y-4 rounded-xl bg-white p-4 shadow-md">
        <div className="flex items-center justify-between">
          <span className="rounded-full bg-gray-black px-3 py-1 text-sm font-bold text-white">
            {order}번
          </span>
        ...
        <div className="flex gap-2 text-b-2">
          <button className="flex-1 rounded-3xl bg-gray-100 py-3 font-bold text-gray-black">
            전화하기
          </button>
          <button className="flex-1 rounded-2xl bg-red-500 py-3 font-bold text-white">
            취소
          </button>
          <button className="flex-1 rounded-2xl bg-primary-300 py-3 font-bold text-black">
            착석
          </button>
        </div>
      </div>
